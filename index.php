        ...
        <div class="container py-2">
            ...
            <div class="collapse navbar-collapse" id="textoNavbar">
                ...
                <?php if ($_SESSION  == null) { ?>
                    <a href="login.php"><button type="button" class="btn btn-outline-light cor-primaria">Login</button></a>
                    <a href="usuario_cadastro.php"><button type="button" class="btn btn-outline-light cor-primaria ml-4">Cadastrar</button></a>

                <?php } else if ($_SESSION["admin"] == 1) { ?>
                    <a href="./utils/sair.php"><button type="button" class="btn btn-outline-light cor-primaria">Sair</button></a>
                    <a href="./painel/painel.php"><button type="button" class="btn btn-outline-light cor-primaria ml-4">Painel</button></a>
                <?php
                } else { ?>
                    <a href="./utils/sair.php"><button type="button" class="btn btn-outline-light cor-primaria">Sair</button></a>
                <?php } ?>
                ...
                <div class="col-12" id="rodape-conteudo">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3" id="contact-container">
                            ...
                            <p class="secondary-color">contato@mercearia5ciclo.com</p>
                        </div>
                    </div>
                </div>
                <!-- FIM RODAPÉ -->
