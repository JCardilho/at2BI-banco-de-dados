...
if ($data_inicial == "" && $data_final == "") {
    ...
    $sql = "SELECT * FROM pedidos INNER JOIN clientes ON pedidos.id_cliente = clientes.id WHERE pedidos.data_pedido >= '$data_inicial' ORDER BY pedidos.data_pedido DESC";
} elseif ($data_inicial == "" && $data_final != "") {
    $sql = "SELECT * FROM pedidos INNER JOIN clientes ON pedidos.id_cliente = clientes.id WHERE pedidos.data_pedido <= '$data_final' ORDER BY pedidos.data_pedido DESC";
}
